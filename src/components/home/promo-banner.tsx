    ...
    <section className="py-12 md:py-16">
      <div className="container mx-auto px-4">
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <SlideInLeft>
            <div className="from-ink-1 via-muted-7 to-muted-5 relative overflow-hidden rounded-3xl bg-gradient-to-r p-8 text-white shadow-[0_30px_70px_rgba(15,23,42,0.35)] md:p-12">
          ...
          <SlideInRight>
            <div className="from-brand-1 via-sand-5 to-sand-6 relative overflow-hidden rounded-3xl bg-gradient-to-r p-8 text-white shadow-[0_30px_70px_rgba(26,86,219,0.25)] md:p-12">
              <div className="relative z-10">
                <span className="mb-2 inline-block rounded-full bg-white/20 px-4 py-1 text-xs tracking-[0.2em] uppercase">
                  For Businesses
                </span>
